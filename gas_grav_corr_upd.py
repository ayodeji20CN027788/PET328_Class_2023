...
if co2_comp <= 0.12 or n2_comp <= 0.03 or h2s_comp <= 0:
    ...
    print('The corrected gas gravity is', round(gas_gravity, 4))
...
# computing pseudo-reduced pressure and temperature of the hydrocarbon mixture

p_pr = ((1- h2s_comp - co2_comp - n2_comp - h2o_comp)*p_pch) + \
          (1306*h2s_comp) + (1071*co2_comp) + (4931*n2_comp) + (3200.1*h2o_comp)
t_pr = ((1- h2s_comp - co2_comp - n2_comp - h2o_comp)*p_pch) + \
          (672.35*h2s_comp) + (547.58*co2_comp) + (227.16*n2_comp) + (1164.9*h2o_comp)

# displaying the results.
print('The hydrocarbon pseudo-reduced pressure is {0:.1f} psia'.format(p_prh))
print('The hydrocarbon pseudo-reduced temperature is {0:.1f} deg Rankine'.format(t_prh))
